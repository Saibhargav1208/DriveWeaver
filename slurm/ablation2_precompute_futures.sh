#!/bin/bash
#SBATCH --job-name=abl2_cache
#SBATCH --output=/data1/work/j0987341/aadya/research/DriveWeaver/logs/ablation2_precompute-%j.out
#SBATCH --error=/data1/work/j0987341/aadya/research/DriveWeaver/logs/ablation2_precompute-%j.err
...
OUTPUT_DIR=/work/data/future_slots/cjepa_vlm
...
docker exec \
  ...
  bash -lc "
    ...
    test -d '${VLM_CACHE_DIR}'
  "

log_section "Precompute C-JEPA+VLM future slots"
OVERWRITE_ARG=""
